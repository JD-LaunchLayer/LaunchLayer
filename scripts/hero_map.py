HERO_BY_SLUG = {
    'laptop-mot-wickford-essex': ('/assets/images/image-4307083f.png', 'LaunchLayer Wickford workshop bench ready for a laptop MOT'),
    ...
    'custom-pc-builds': ('/assets/images/image-ddefba94.jpg', 'Custom gaming PC with Radeon GPU and RGB liquid cooling'),
    'eco-recycling': ('/assets/images/image-eco-donate-hero.jpg', 'Laptop donation for children — LaunchLayer recycling partnership'),
    'wickford-virus-removal': ('/assets/images/image-9258d33d.jpg', 'Laptop showing malware warning — virus and scam recovery'),
    'laptop-screen-repair-wickford': ('/assets/images/image-laptop-display-banner.jpg', 'Laptop display — screen replacement in Wickford'),
    ...
    'macbook-repair-rayleigh': ('/assets/images/image-69f0c879.jpg', 'Silver MacBook — Rayleigh MacBook repair'),
    ...
    'liquid-damage-repair-rayleigh': ('/assets/images/image-a07b70ec.webp', 'Technician opening a laptop after liquid spill — Rayleigh'),
    ...
    'screen-repair-rayleigh': ('/assets/images/image-de2f0024.jpg', 'Open laptop on desk — Rayleigh screen repair'),
